...
|----------------|------|------|--------|
| **Logo** | [`linkedin-logo.png`](../site/brand/linkedin-logo.png) | 1024×1024 | Square mark only (`>_`). Not `lockup.png`. If the tile shows the word VAULTRUN inside the logo, you uploaded the lockup. |
